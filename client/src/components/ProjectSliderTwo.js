    ...
    let data = [
      {
        ...
        serviceExcerpt:
          "This course explores Javascript based front-end application development, and in particular the React library.This course will use JavaScript ES6 for developing React application.",
      ...
      },
      {
        ...
        serviceExcerpt:
          "MongoDB is one of the most important NoSQL databases you can work with these days. It's extremely popular and MongoDB developers are in high demand.MongoDB is one of the most important NoSQL databases.",
        serviceUrl: "service-details-left-sidebar"
      }
    ];
